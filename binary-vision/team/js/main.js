...
$(window).scroll(function(event){
    var st = $(this).scrollTop(),
        block_pos = $(".block_pos").offset().top - 200,
...
(function () {
    ...
    const burger_wrap = document.querySelector('.hamburger-wrap');
    ...
    elmHamburger.addEventListener('click', () => {
        ...
        if (overlay.isOpened === true) {
            burger_wrap.style.transform = "none";
...
$(".next").click(function () {
    ...
    if (in_hid.length >= '1') {
        $("#btn-next").addClass("btn-vis");
        $(".write-value").addClass("text-form-opas").children(".describe").attr("disabled", "disabled");
        in_hid[0].classList.remove('input-hidden');
    }
});

$(".form-foot").on("submit", function(event) {
